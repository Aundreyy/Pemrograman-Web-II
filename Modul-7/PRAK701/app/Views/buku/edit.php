    ...
    <div class="container">
        ...
        <form action="/buku/update/<?= $buku['id']; ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" value="<?= (old('judul')) ? old('judul') : $buku['judul']; ?>">
                <span class="error-text"><?= $validation->getError('judul'); ?></span>
            </div>

            <div class="form-group">
                <label for="penulis">Penulis</label>
                <input type="text" id="penulis" name="penulis" value="<?= (old('penulis')) ? old('penulis') : $buku['penulis']; ?>">
                <span class="error-text"><?= $validation->getError('penulis'); ?></span>
            </div>

            <div class="form-group">
                <label for="penerbit">Penerbit</label>
                <input type="text" id="penerbit" name="penerbit" value="<?= (old('penerbit')) ? old('penerbit') : $buku['penerbit']; ?>">
                <span class="error-text"><?= $validation->getError('penerbit'); ?></span>
            </div>

            <div class="form-group">
                <label for="tahun_terbit">Tahun Terbit</label>
                <input type="number" id="tahun_terbit" name="tahun_terbit" value="<?= (old('tahun_terbit')) ? old('tahun_terbit') : $buku['tahun_terbit']; ?>">
